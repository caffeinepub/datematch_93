...
const DEFAULT_STORAGE_GATEWAY_URL = isLocal
  ? "http://localhost:6188"
...
export async function loadConfig(): Promise<Config> {
  ...
  try {
    ...
    console.log("DateMatch Config Loaded:", {
      gateway: fullConfig.storage_gateway_url,
    ...
    console.log("DateMatch Config Loaded (Fallback):", {
      gateway: fallbackConfig.storage_gateway_url,
      hostname: window.location.hostname,
    });
